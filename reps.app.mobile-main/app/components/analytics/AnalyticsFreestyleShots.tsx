...
import { useNumberOfThrowsByMonth } from '../../hooks/useNumberOfThrowsByMonth.hook';

import AnalyticsWrapper from './AnalyticsWrapper';

const white = 'white';

const AnalyticsFreestyleShots: FC = (): JSX.Element => {
  const lastFiveMonths = useGetLastNumMonths(5);

  const numberOfThrowsByMonth = useNumberOfThrowsByMonth();
  ...
  return (
    <AnalyticsWrapper title={'Total Shots'}>
      <BarChart
...
export default AnalyticsFreestyleShots;
