...
const TrainingStrengthScreen: FC = (): JSX.Element => {
  const navigation = useNavigation<StackNavigationProp>();
  return (
    <Flex flex={1}>
      <MainHeader title={'Strength & Conditioning'} canGoBack={true} />
      <TwoCardUpList
        data={data}
        header={
        ...
        onPressItem={(): void => {
          navigation.navigate(TrainingNavigation.TrainingStrengthItemScreen);
        }}
      />
    </Flex>
  );
...
export default TrainingStrengthScreen;
